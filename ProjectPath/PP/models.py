...
class CompteEtudiant(AbstractUser, PermissionsMixin):
    ...
    adresse_mail = models.fields.EmailField(blank=True, max_length=254, verbose_name='email address',default = "Bonjour@estin.dz", validators=[Validate_email_adress])
    telephone = models.fields.IntegerField(validators=[Validate_telephone], default=42)
    
    EMAIL_FIELD = 'adresse_mail'
