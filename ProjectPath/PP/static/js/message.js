...
function renderList(list,filter = "") {
    ...
    filtered.forEach(msg => {
        ...
        div.innerHTML = `
         <div class="msg-avatar"><span id="s1">${msg.fields.emetteur[0]}</span></div>
            <div class="msg-info">
            ...
            ${!msg.fields.vu ? '<span class="msg-unread-dot"></span>' : ''}
        `;
...
function selectMessage(id) {
    ...
    detail.innerHTML = `
        <<div class="detail-header">
            <div class="detail-avatar">${msg.fields.emetteur[0]}</div>
        ...
        <div class="detail-body">
            ...
            <div class="detail-tag">
                <i class="fa-solid fa-link"></i> Du projet: ${msg.fields.projet}
            </div>
        </div>
